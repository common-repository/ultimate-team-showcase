...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		...
		_doing_it_wrong( 'WP_REST_Controller::register_routes', sprintf( esc_html__( "Method '%s' must be overridden.", 'ultimate-team-showcase'  ), __METHOD__ ), '4.7' );
	}
	...
	public function get_items_permissions_check( $request ) {
		// translators: get_items_permissions_check
	...
	public function get_item_permissions_check( $request ) {
		// translators: get_item_permissions_check
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass." ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	public function create_item_permissions_check( $request ) {
		// translators: create_item_permissions_check
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass." ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	public function update_item_permissions_check( $request ) {
		// translators: update_item_permissions_check
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass." ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	public function delete_item_permissions_check( $request ) {
		// translators: delete_item_permissions_check
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass." ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	protected function prepare_item_for_database( $request ) {
		// translators: prepare_item_for_database
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass." ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
	...
	public function prepare_item_for_response( $item, $request ) {
		// translators: prepare_item_for_response
		return new WP_Error( 'invalid-method', sprintf( __( "Method '%s' not implemented. Must be overridden in subclass." ), __METHOD__ ), array(
			'status' => 405,
		) );
	}
