<?php
/**
 * RSTHEME taxonomy_select field type
 *
 * @since  2.2.2
 *
 ...
 * @link      https://rs.io
 */
class RSTHEME_Type_Taxonomy_Select extends RSTHEME_Type_Taxonomy_Base {
	...
	public function render() {
		...
		if ( ! empty( $option_none ) ) {
			 ...
			 */
			$option_none_value = apply_filters( 'rs_taxonomy_select_default_value', '' );
			 ...
			 * @param string $option_none_value Default (option-none) taxonomy-select value.
			 */
			$option_none_value = apply_filters( "rs_taxonomy_select_{$field_id}_default_value", $option_none_value );
