<?php
/**
 * RSTHEME taxonomy_radio field type
 *
 * @since  2.2.2
 *
 ...
 * @link      https://rs.io
 */
class RSTHEME_Type_Taxonomy_Radio extends RSTHEME_Type_Taxonomy_Base {
	protected $counter = 0;
	...
	protected function get_term_options() {
		...
		if ( ! empty( $option_none ) ) {
			 ...
			 */
			$option_none_value = apply_filters( 'rs_taxonomy_radio_default_value', '' );
			 ...
			 * @param string $option_none_value Default (option-none) taxonomy-radio value.
			 */
			$option_none_value = apply_filters( "rs_taxonomy_radio_{$field_id}_default_value", $option_none_value );
