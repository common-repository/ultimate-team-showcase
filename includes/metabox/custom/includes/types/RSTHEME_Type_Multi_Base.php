 ...
 * @link      https://rs.io
 */
abstract class RSTHEME_Type_Multi_Base extends RSTHEME_Type_Base {
	...
	public function concat_items( $args = array() ) {
		...
		$value = RSTHEME_Utils::normalize_if_numeric( $value );
		...
		foreach ( $options as $opt_value => $opt_label ) {
			...
			if ( $value === RSTHEME_Utils::normalize_if_numeric( $opt_value ) ) {
				$a['checked'] = 'checked';
			}
