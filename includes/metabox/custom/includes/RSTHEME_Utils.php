...
class RSTHEME_Utils {
	 ...
	 *
	 * @since  1.0.1
	 * @return string URL to RSTHEME resources
	 */
	public static function url( $path = '' ) {
		...
		$rstheme_url = self::get_url_from_dir( rstheme_dir() );

		/**
		 * Filter the RSTHEME location url
		 *
		 * @param string $rstheme_url Currently registered url
		 */
		self::$url = trailingslashit( apply_filters( 'rstheme_meta_box_url', $rstheme_url, RSTHEME_VERSION ) );
	...
	/**
	 * Helper function for RSTHEME_Utils::php_to_js_dateformat().
	 *
	 * @since  2.2.0
